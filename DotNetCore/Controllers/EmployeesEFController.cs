...
namespace Core.Controllers
{
    public class EmployeesEFController : Controller
    {
        ...
        public EmployeesEFController(AppDbContext context)
        {
            _context = context;
        }
